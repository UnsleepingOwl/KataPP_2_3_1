...
public class SpringHibernateConfig implements WebMvcConfigurer {
    private final ApplicationContext applicationContext;

    private final Environment environment;

    public SpringHibernateConfig(ApplicationContext applicationContext, Environment environment) {
    ...
    public LocalSessionFactoryBean getSessionFactory() {
        ...
        factoryBean.setPackagesToScan("kata.web.model");
